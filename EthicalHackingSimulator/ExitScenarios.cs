...
namespace EthicalHackingSimulator
{
    public class ExitScenarios
    {
        ...
        private void ReverseShellScenario(bool rootkit)
        {
            ...
            if(rootkit)
            {
                string rk1 = "\nYou have chosen to install a rootkit along with your exploit. This allows you to maintain access to the target's computer, even after they restart it.\n";
            ...
            {
                string noRk1 = "\nYou have not chosen to install a rootkit along with your exploit. Rootkits allow you maintain access to a target's computer, even after it is restarted.\n";
        ...
        private void FileUploadScenario(bool rootkit)
        {
            ...
            {                
                ...
                {
                    baseOutput = "Error in parsing filetype.";
                    return;
                }
